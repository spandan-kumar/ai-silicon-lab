// FIPS 197 AES substitution box.
//
// This table is a plain lookup. It is not masked and makes no constant-power
// claim; the experiment's security review records that explicitly rather than
// inferring a side-channel property from functional correctness.
